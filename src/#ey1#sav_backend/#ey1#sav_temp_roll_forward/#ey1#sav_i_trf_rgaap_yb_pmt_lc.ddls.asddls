@AbapCatalog.sqlViewName: '/EY1/IRGYBPMTLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP YB PMNT - LC'

@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_YB_PMT_LC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
