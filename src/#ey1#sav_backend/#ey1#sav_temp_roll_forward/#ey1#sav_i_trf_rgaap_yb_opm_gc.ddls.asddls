@AbapCatalog.sqlViewName: '/EY1/IRGYBOPMGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP YB Other PMNT - GC'

@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_YB_OPM_GC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
