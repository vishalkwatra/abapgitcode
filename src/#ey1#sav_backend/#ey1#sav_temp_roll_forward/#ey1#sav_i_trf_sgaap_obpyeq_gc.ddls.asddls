@AbapCatalog.sqlViewName: '/EY1/ISGOBPYEQGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fws SGAAP OB PY EQ GC'
define view /EY1/SAV_I_TRF_SGAAP_OBPYEq_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount           as GLAccount,
       ...
       sum(PYA.amountgroupcur) as PYAOBEq,
