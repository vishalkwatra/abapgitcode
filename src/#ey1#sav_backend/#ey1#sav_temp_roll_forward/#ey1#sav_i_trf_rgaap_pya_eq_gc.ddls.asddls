@AbapCatalog.sqlViewName: '/EY1/IRGPYAEQGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP PYA EQ GC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_PYA_Eq_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount           as GLAccount,
       ...
       sum(PYA.amountgroupcur) as PYAEq,
