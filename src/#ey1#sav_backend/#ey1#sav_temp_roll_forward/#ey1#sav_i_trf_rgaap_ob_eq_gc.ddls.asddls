@AbapCatalog.sqlViewName: '/EY1/IRGOBEQGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP OB EQ - GC'

@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_OB_EQ_GC
  with parameters
    p_ryear        : gjahr,
