@AbapCatalog.sqlViewName: '/EY1/IRGPYAOPLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP PYA OPL LC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_PYA_OP_LC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount        as GLAccount,
       ...
       sum(PYA.yearbalance) as PYAOPLAmount,
