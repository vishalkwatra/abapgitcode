@AbapCatalog.sqlViewName: '/EY1/ISGPYAPMGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'TRF Report - PYA Amount for PMNT'
define view /EY1/SAV_ITRF_SGAAP_PYA_Pmt_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount           as GLAccount,
       ...
       sum(PYA.amountgroupcur) as PYAPMTAmount,
