@AbapCatalog.sqlViewName: '/EY1/IRGOBPMNRLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP OB Pmt Normalize LC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_TRF_RGAAP_OBPmNR_LC
  with parameters
    p_ryear        : gjahr,
    //    p_specialperiod : zz1_specialperiod
    p_taxintention : zz1_taxintention,
    p_toperiod     : poper
  as select from    /EY1/SAV_I_TRF_RGAAP_OB_PMT_LC(
                    p_ryear:$parameters.p_ryear ,
                    p_taxintention:$parameters.p_taxintention ) as OBPmt
    left outer join /EY1/SAV_I_TRF_RGAAP_OBPYPm_LC(
                    p_ryear:$parameters.p_ryear ,
