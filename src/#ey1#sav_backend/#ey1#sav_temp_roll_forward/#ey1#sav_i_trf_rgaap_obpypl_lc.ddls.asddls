@AbapCatalog.sqlViewName: '/EY1/IRGOBPYPLLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP OB PYA PL LC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_OBPYPL_LC
  with parameters
    p_ryear        : gjahr,
