@AbapCatalog.sqlViewName: '/EY1/IRGPYAOEQGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP PYA OEQ GC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_PYA_OE_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount           as GLAccount,
       ...
       sum(PYA.amountgroupcur) as PYAOeq,
