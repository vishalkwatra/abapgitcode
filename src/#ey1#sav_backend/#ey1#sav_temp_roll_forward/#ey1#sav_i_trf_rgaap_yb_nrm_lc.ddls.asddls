@AbapCatalog.sqlViewName: '/EY1/IRGYBNRMLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to normalize values of RGAAP YB - LC'
@VDM.viewType: #COMPOSITE
define view /EY1/SAV_I_TRF_RGAAP_YB_NRM_LC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
  ...
  as select distinct from /EY1/SAV_I_GlAcc_TRF_MD
    ...
    left outer join       /EY1/SAV_I_TRF_RGAAP_YB_PL_LC
    ...
    left outer join       /EY1/SAV_I_TRF_RGAAP_YB_PMT_LC
                    ( p_toperiod :$parameters.p_toperiod,
                          p_ryear:$parameters.p_ryear,
    ...
    left outer join       /EY1/SAV_I_TRF_RGAAP_YB_EQ_LC
                    ( p_toperiod :$parameters.p_toperiod,
                          p_ryear:$parameters.p_ryear,
    ...
    left outer join       /EY1/SAV_I_TRF_RGAAP_YB_OPL_LC
                    ( p_toperiod :$parameters.p_toperiod,
                          p_ryear:$parameters.p_ryear,
    ...
    left outer join       /EY1/SAV_I_TRF_RGAAP_YB_OPM_LC
                    ( p_toperiod :$parameters.p_toperiod,
                          p_ryear:$parameters.p_ryear,
    ...
    left outer join       /EY1/SAV_I_TRF_RGAAP_YB_OEQ_LC
                    ( p_toperiod :$parameters.p_toperiod,
                            p_ryear:$parameters.p_ryear,
