@AbapCatalog.sqlViewName: '/EY1/IRGYBPLGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP YB P&L - GC'

@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_YB_PL_GC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
