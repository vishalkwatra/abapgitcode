@AbapCatalog.sqlViewName: '/EY1/IRGPYAPMTC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP PYA Permanent GC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_PYA_Pm_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount           as GLAccount,
       ...
       sum(PYA.amountgroupcur) as PYAPmnt,
...
where
  ...
  and PYA.transactiontype    =  'PERMANENT'
