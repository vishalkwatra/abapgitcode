@AbapCatalog.sqlViewName: '/EY1/ISGPYAEQGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'TRF Report - PYA Amount for EQ'
define view /EY1/SAV_ITRF_SGAAP_PYA_EQ_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount           as GLAccount,
       ...
       sum(PYA.amountgroupcur) as PYAEqAmount,
