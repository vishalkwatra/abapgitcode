@AbapCatalog.sqlViewName: '/EY1/IRGLCGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP Local & Group Currency Union'

@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_TRF_RGAAP_LCGC_Uni
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
                                                                            ...
                                                                            and TaxRate.FiscalYear        = $parameters.p_ryear
{
  ...
  key AccountClassCode,
      ...
      //Tax Rates
      TaxRate.GaapOBDTRate as OBRate,
      TaxRate.GaapCBDTRate as CBRate,
