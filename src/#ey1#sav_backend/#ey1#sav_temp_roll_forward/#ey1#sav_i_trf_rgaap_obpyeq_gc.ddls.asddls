@AbapCatalog.sqlViewName: '/EY1/IRGOBPYEQGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP OB PYA Eq GC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_OBPYEq_GC
  with parameters
    p_ryear        : gjahr,
