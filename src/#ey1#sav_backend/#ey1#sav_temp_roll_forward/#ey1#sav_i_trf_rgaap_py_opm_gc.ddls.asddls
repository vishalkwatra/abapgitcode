@AbapCatalog.sqlViewName: '/EY1/IRGPYAPMGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP PYA OPermanent GC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_PY_OPm_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount           as GLAccount,
       ...
       sum(PYA.amountgroupcur) as PYAOpmnt,
