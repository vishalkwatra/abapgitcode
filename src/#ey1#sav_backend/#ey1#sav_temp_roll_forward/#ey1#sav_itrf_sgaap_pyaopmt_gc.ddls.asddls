@AbapCatalog.sqlViewName: '/EY1/ISGPYAOPMGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'TRF Report - PYA Amount for OPMNT'
define view /EY1/SAV_ITRF_SGAAP_PYAOpmt_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount           as GLAccount,
       ...
       sum(PYA.amountgroupcur) as PYAOpmntAmount,
