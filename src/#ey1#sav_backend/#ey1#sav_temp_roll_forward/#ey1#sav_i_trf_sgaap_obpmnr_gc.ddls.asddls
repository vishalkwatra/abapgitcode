@AbapCatalog.sqlViewName: '/EY1/ISGOBPMNRGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fws SGAAP OB Pmt Normalize GC'
define view /EY1/SAV_I_TRF_SGAAP_OBPmNR_GC
  with parameters
    p_ryear        : gjahr,
    //    p_specialperiod : zz1_specialperiod
    p_taxintention : zz1_taxintention,
    p_toperiod     : poper
  as select from    /EY1/SAV_I_TRF_SGAAP_OB_PMT_GC(
                    p_ryear:$parameters.p_ryear ,
                    p_taxintention:$parameters.p_taxintention ) as OBPmt
    left outer join /EY1/SAV_I_TRF_SGAAP_OBPYPm_GC(
                    p_ryear:$parameters.p_ryear ,
