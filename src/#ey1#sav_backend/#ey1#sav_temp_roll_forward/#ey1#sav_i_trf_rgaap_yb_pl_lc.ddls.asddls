@AbapCatalog.sqlViewName: '/EY1/IRGYBPLLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View for Temp Roll Fwd RGAAP YB P&L'

@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_YB_PL_LC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
