@AbapCatalog.sqlViewName: '/EY1/IRGOBPYPMGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd RGAAP OB PYA Pmt GC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_RGAAP_OBPYPm_GC
  with parameters
    p_ryear        : gjahr,
     ...
     )
{
  ...
  key  PYA.glaccount       as GLAccount,
       ...
       sum(amountgroupcur) as PYAOBPmt,
