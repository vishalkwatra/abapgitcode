@AbapCatalog.sqlViewName: '/EY1/ISGOBPLLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Temp Roll Fwd SGAAP OB PL- LC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_TRF_SGAAP_OB_PL_LC
  with parameters
    p_ryear         : gjahr,
