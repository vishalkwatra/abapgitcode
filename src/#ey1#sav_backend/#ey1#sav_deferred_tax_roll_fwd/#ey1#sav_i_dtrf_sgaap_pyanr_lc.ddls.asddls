@AbapCatalog.sqlViewName: '/EY1/IDSGPYANRLC'
...
define view /EY1/SAV_I_DTRF_SGAAP_PYANR_LC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
  ...
  as select from    /EY1/SAV_I_GlAcc_DTRF_MD (p_ryear : $parameters.p_ryear)             as GLAccnt
    left outer join /EY1/SAV_I_DTRF_SGAAP_PYA_PL(p_ryear : $parameters.p_ryear,
    ...
    left outer join /EY1/SAV_I_DTRF_SGAAP_PYA_EQ(p_ryear : $parameters.p_ryear,
                                                 p_taxintention : $parameters.p_taxintention,
                                                 p_toperiod     : $parameters.p_toperiod,
    ...
    left outer join /EY1/SAV_I_DTRF_SGAAP_PYA_OPl(p_ryear : $parameters.p_ryear,
                                                 p_taxintention : $parameters.p_taxintention,
                                                 p_toperiod     : $parameters.p_toperiod,
    ...
    left outer join /EY1/SAV_I_DTRF_SGAAP_PYA_OEq(p_ryear : $parameters.p_ryear,
                                                 p_taxintention : $parameters.p_taxintention,
                                                 p_toperiod     : $parameters.p_toperiod,
