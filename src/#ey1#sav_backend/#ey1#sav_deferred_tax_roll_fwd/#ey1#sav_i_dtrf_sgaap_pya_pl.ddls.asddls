@AbapCatalog.sqlViewName: '/EY1/DTRFSPYAPL'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Deferred Tax Roll Forward PYA-PL'
define view /EY1/SAV_I_DTRF_SGAAP_PYA_PL
