@AbapCatalog.sqlViewName: '/EY1/IDSGPYANRGC'
...
define view /EY1/SAV_I_DTRF_SGAAP_PYANR_GC
  with parameters
    p_ryear        : gjahr,
  ...
  as select from    /EY1/SAV_I_GlAcc_DTRF_MD (p_ryear : $parameters.p_ryear)             as GLAccnt
    left outer join /EY1/SAV_I_DTRF_SGAAP_PYA_PLGC(p_ryear : $parameters.p_ryear,
    ...
    left outer join /EY1/SAV_I_DTRF_SGAAP_PYA_EQGC(p_ryear : $parameters.p_ryear,
                                                 p_taxintention : $parameters.p_taxintention,
                                                 p_toperiod     : $parameters.p_toperiod,
    ...
    left outer join /EY1/SAV_I_DTRF_SGAAPPYA_OPlGC(p_ryear : $parameters.p_ryear,
                                                 p_taxintention : $parameters.p_taxintention,
                                                 p_toperiod     : $parameters.p_toperiod,
    ...
    left outer join /EY1/SAV_I_DTRF_SGAAP_PYAOEqGC(p_ryear : $parameters.p_ryear,
                                                 p_taxintention : $parameters.p_taxintention,
                                                 p_toperiod     : $parameters.p_toperiod,
