@AbapCatalog.sqlViewName: '/EY1/DTRFROBPLLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View Deferred Tax Roll Forward OB P&L - LC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_DTRF_RGAAP_OB_PL_LC
  with parameters
    p_ryear        : gjahr,
...
where
  ...
  and     ryear                     <  :p_ryear
  //  and(
  //          zz1_specialperiod_cje     =  ''
  //    or    zz1_specialperiod_cje     <= :p_specialperiod
  //  )
  and(
