class /EY1/CL_SAV_TAX_RAT_01_DPC definition
  public
...
protected section.
  ...
  methods XEY1XSAV_C_CTR_T_UPDATE_ENTITY
    ...
    exporting
      !ER_ENTITY type /EY1/CL_SAV_TAX_RAT_01_MPC=>TS_XEY1XSAV_C_CTR_TAX_RATESTYP
    raising
  ...
  methods XEY1XSAV_C_CTR_T_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type /EY1/CL_SAV_TAX_RAT_01_MPC=>TT_XEY1XSAV_C_CTR_TAX_RATESTYP
  ...
  methods XEY1XI_READINTEN_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type /EY1/CL_SAV_TAX_RAT_01_MPC=>TS_XEY1XI_READINTENTVHTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods XEY1XI_READINTEN_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type /EY1/CL_SAV_TAX_RAT_01_MPC=>TT_XEY1XI_READINTENTVHTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods I_LANGUAGE_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type /EY1/CL_SAV_TAX_RAT_01_MPC=>TS_I_LANGUAGETYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods I_LANGUAGE_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type /EY1/CL_SAV_TAX_RAT_01_MPC=>TT_I_LANGUAGETYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods I_DRAFTADMINISTR_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type /EY1/CL_SAV_TAX_RAT_01_MPC=>TS_I_DRAFTADMINISTRATIVEDATATY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods I_DRAFTADMINISTR_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type /EY1/CL_SAV_TAX_RAT_01_MPC=>TT_I_DRAFTADMINISTRATIVEDATATY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods I_CNSLDTNUNITT_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type /EY1/CL_SAV_TAX_RAT_01_MPC=>TS_I_CNSLDTNUNITTTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods I_CNSLDTNUNITT_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type /EY1/CL_SAV_TAX_RAT_01_MPC=>TT_I_CNSLDTNUNITTTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods I_CNSLDTNDIMENSI_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type /EY1/CL_SAV_TAX_RAT_01_MPC=>TS_I_CNSLDTNDIMENSIONTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods I_CNSLDTNDIMENSI_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type /EY1/CL_SAV_TAX_RAT_01_MPC=>TT_I_CNSLDTNDIMENSIONTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods C_CNSLDTNUNITVAL_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type /EY1/CL_SAV_TAX_RAT_01_MPC=>TS_C_CNSLDTNUNITVALUEHELPTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods C_CNSLDTNUNITVAL_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type /EY1/CL_SAV_TAX_RAT_01_MPC=>TT_C_CNSLDTNUNITVALUEHELPTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS /EY1/CL_SAV_TAX_RAT_01_DPC IMPLEMENTATION.
...
*&* This class has been generated on 21.01.2021 12:02:19 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - /EY1/CL_SAV_TAX_RAT_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA i_draftadministr_create_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_draftadministrativedataty.
 DATA xey1xi_readinten_create_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_xey1xi_readintentvhtype.
 DATA i_cnsldtnunitt_create_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_cnsldtnunitttype.
 DATA i_cnsldtndimensi_create_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_cnsldtndimensiontype.
 DATA i_language_create_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_languagetype.
 DATA xey1xsav_c_ctr_t_create_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_xey1xsav_c_ctr_tax_ratestyp.
 DATA c_cnsldtnunitval_create_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_c_cnsldtnunitvaluehelptype.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA c_cnsldtnunitval_get_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_c_cnsldtnunitvaluehelptype.
 DATA i_cnsldtndimensi_get_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_cnsldtndimensiontype.
 DATA i_language_get_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_languagetype.
 DATA xey1xsav_c_ctr_t_get_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_xey1xsav_c_ctr_tax_ratestyp.
 DATA i_cnsldtnunitt_get_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_cnsldtnunitttype.
 DATA i_draftadministr_get_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_draftadministrativedataty.
 DATA xey1xi_readinten_get_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_xey1xi_readintentvhtype.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - /EY1/CL_SAV_TAX_RAT_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA c_cnsldtnunitval_get_entityset TYPE /ey1/cl_sav_tax_rat_01_mpc=>tt_c_cnsldtnunitvaluehelptype.
 DATA i_cnsldtndimensi_get_entityset TYPE /ey1/cl_sav_tax_rat_01_mpc=>tt_i_cnsldtndimensiontype.
 DATA xey1xsav_c_ctr_t_get_entityset TYPE /ey1/cl_sav_tax_rat_01_mpc=>tt_xey1xsav_c_ctr_tax_ratestyp.
 DATA i_cnsldtnunitt_get_entityset TYPE /ey1/cl_sav_tax_rat_01_mpc=>tt_i_cnsldtnunitttype.
 DATA i_language_get_entityset TYPE /ey1/cl_sav_tax_rat_01_mpc=>tt_i_languagetype.
 DATA i_draftadministr_get_entityset TYPE /ey1/cl_sav_tax_rat_01_mpc=>tt_i_draftadministrativedataty.
 DATA xey1xi_readinten_get_entityset TYPE /ey1/cl_sav_tax_rat_01_mpc=>tt_xey1xi_readintentvhtype.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA i_language_update_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_languagetype.
 DATA i_draftadministr_update_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_draftadministrativedataty.
 DATA i_cnsldtnunitt_update_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_cnsldtnunitttype.
 DATA i_cnsldtndimensi_update_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_i_cnsldtndimensiontype.
 DATA c_cnsldtnunitval_update_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_c_cnsldtnunitvaluehelptype.
 DATA xey1xsav_c_ctr_t_update_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_xey1xsav_c_ctr_tax_ratestyp.
 DATA xey1xi_readinten_update_entity TYPE /ey1/cl_sav_tax_rat_01_mpc=>ts_xey1xi_readintentvhtype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    ...
    TYPES ty_/EY1/I_TAX_R_D_10 TYPE /ey1/i_tax_r_d ##NEEDED. " reference for where-used list
