class /EY1/CL_SAV_TAX_RAT_01_MPC definition
  public
...
CLASS /EY1/CL_SAV_TAX_RAT_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'EY1.SAV_TAX_RATES_SRV_01' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210121110216'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20210121120217'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20210121120217'.
    DATA(lv_sadl_xml) =
