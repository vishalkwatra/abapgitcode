class /EY1/CL_SAV_MANAGE_TIE_DPC definition
  public
...
protected section.
  ...
  methods XEY1XSAV_C_TIERS_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type /EY1/CL_SAV_MANAGE_TIE_MPC=>TS_XEY1XSAV_C_TIERSTYPE
    raising
  ...
  methods XEY1XSAV_C_TIERS_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type /EY1/CL_SAV_MANAGE_TIE_MPC=>TT_XEY1XSAV_C_TIERSTYPE
...
CLASS /EY1/CL_SAV_MANAGE_TIE_DPC IMPLEMENTATION.
...
*&* This class has been generated on 22.02.2021 11:04:10 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - /EY1/CL_SAV_MANAGE_TIE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA xey1xsav_c_tiers_create_entity TYPE /ey1/cl_sav_manage_tie_mpc=>ts_xey1xsav_c_tierstype.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA xey1xsav_c_tiers_get_entity TYPE /ey1/cl_sav_manage_tie_mpc=>ts_xey1xsav_c_tierstype.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - /EY1/CL_SAV_MANAGE_TIE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA xey1xsav_c_tiers_get_entityset TYPE /ey1/cl_sav_manage_tie_mpc=>tt_xey1xsav_c_tierstype.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA xey1xsav_c_tiers_update_entity TYPE /ey1/cl_sav_manage_tie_mpc=>ts_xey1xsav_c_tierstype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_/EY1/SAV_C_TIERS_1 TYPE /ey1/sav_c_tiers ##NEEDED. " reference for where-used list
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20210222110408
               iv_uuid              = '/EY1/SAV_MANAGE_TIERS'
