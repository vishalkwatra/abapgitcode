@AbapCatalog.sqlViewName: '/EY1/PRCYTECCRLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View - PR- CYTE - Details Cross Check RGAAP LC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_PR_CYTE_CCRGAAP_LC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  as select from    /EY1/SAV_I_PR_CYTE_GILBT_LC
    ...
    left outer join /EY1/SAV_I_PR_CYTE_ReconChk_LC
                    ( p_toperiod:$parameters.p_toperiod,
                    p_ryear:$parameters.p_ryear,
