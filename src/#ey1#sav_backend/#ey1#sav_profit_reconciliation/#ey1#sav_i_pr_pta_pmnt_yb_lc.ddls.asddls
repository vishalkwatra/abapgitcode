@AbapCatalog.sqlViewName: '/EY1/PRPTAPMYBLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View - PR- PTA Permanent Mvmnt LC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_PR_PTA_Pmnt_YB_LC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
...

{
  ...
  key ryear    as FiscalYear,
      racct    as GLAccount,
      sum(hsl) as PTATransactionsPmnt,
