@AbapCatalog.sqlViewName: '/EY1/PRTAXYBLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View - PR- TAX Ledger Year Mvmnt LC'
@VDM.viewType: #BASIC
define view /EY1/SAV_I_PR_TAX_YB_LC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  as select from acdocu
    ...
    inner join   /EY1/SAV_I_Get_Cnsldtn_Version as GetVersion  on  GetVersion.ConsolidationLedger = ReconLedger.tax
    ...
    
{
  ...
  key  ryear    as FiscalYear,
       ...
       sum(hsl) as TAXLedgerTransactions,
...
where
  ...
  and ryear                 =  :p_ryear
  and acdocu.rldnr          =  ReconLedger.tax
