@AbapCatalog.sqlViewName: '/EY1/PRTAXYBGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View - PR- TAX Ledger Year Mvmnt GC'
@VDM.viewType: #BASIC
define view /EY1/SAV_I_PR_TAX_YB_GC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
    ...
    
{
  ...
  key  ryear    as FiscalYear,
       ...
       sum(ksl) as TAXLedgerTransactions,
