@AbapCatalog.sqlViewName: '/EY1/CPRSECG2S'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'C-View - Profit Recon - G2S Mvmnt'
@VDM.viewType: #CONSUMPTION

define view /EY1/SAV_C_PR_G2S_Mvmnt
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
    p_taxintention : zz1_taxintention
  as select from /EY1/SAV_I_PR_G2S_Mvmnt
