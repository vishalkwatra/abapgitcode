@AbapCatalog.sqlViewName: '/EY1/PRG2SCCSGGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View - PR- G2S - Details Cross Check SGAAP GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_PR_G2S_CCSGAAP_GC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  as select from    /EY1/SAV_I_PR_G2S_SILBT_GC
    ...
    left outer join /EY1/SAV_I_PR_G2S_ReconChk_GC
                    ( p_toperiod:$parameters.p_toperiod,
                    p_ryear:$parameters.p_ryear,
