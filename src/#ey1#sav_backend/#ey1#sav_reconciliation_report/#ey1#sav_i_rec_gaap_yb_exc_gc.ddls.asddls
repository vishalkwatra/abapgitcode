@AbapCatalog.sqlViewName: '/EY1/GAAPYBEXC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I- View for GAAP YB Calculation Excluding CTA'

define view /EY1/SAV_I_Rec_GAAP_YB_EXC_GC
  with parameters
    p_ryear        : gjahr,
    p_fromyb       : poper,
    p_toyb         : poper,
