@AbapCatalog.sqlViewName: '/EY1/SGAAPYBNPL'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I view for GAAP YB Calculation - Non P&L'

define view /EY1/SAV_I_Rec_GAAP_YB_NPL_GC
  with parameters
    p_ryear        : gjahr,
    p_fromyb       : poper,
    p_toyb         : poper,
