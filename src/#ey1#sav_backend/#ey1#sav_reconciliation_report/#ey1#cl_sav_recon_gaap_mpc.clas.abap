class /EY1/CL_SAV_RECON_GAAP_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_DATAMONITORPARAMETERS,
    ...
    end of TS_DATAMONITORPARAMETERS .
  types:
  ...
  types:
    begin of TS_POSTINGDATE,
        CONSOLIDATIONUNIT type C length 18,
        POPER type C length 3,
        FISCALYEAR type C length 4,
    end of TS_POSTINGDATE .
  types:
    begin of TS_CONVERTCURRENCY,
        AMOUNT type P length 13 decimals 3,
        EXCHANGERATEDATE type TIMESTAMP,
        FROMCURRENCY type C length 5,
        TOCURRENCY type C length 5,
    end of TS_CONVERTCURRENCY .
  types:
    begin of TS_DETERMINEPERIOD,
        CHAR4 type string,
        RBUNIT type string,
        DATE type TIMESTAMP,
    end of TS_DETERMINEPERIOD .
  types:
    begin of TS_GLOBALPARAMETER,
        DEFAULT type FLAG,
    end of TS_GLOBALPARAMETER .
  types:
  begin of TS_DATAMONITORPARAMETERS01,
     ...
     URL type string,
  end of TS_DATAMONITORPARAMETERS01 .
  types:
TT_DATAMONITORPARAMETERS type standard table of TS_DATAMONITORPARAMETERS01 .
  types:
  begin of TS_LEDGER,
     BUNIT type string,
     RLDNR type string,
...
TT_LEDGER type standard table of TS_LEDGER .
  types:
  begin of TS_POSTINGDATE02,
     POSTINGDATE type C length 8,
  end of TS_POSTINGDATE02 .
  types:
TT_POSTINGDATE type standard table of TS_POSTINGDATE02 .
  types:
  begin of TS_CONVERTCURRENCY03,
     FROMAMOUNT type P length 16 decimals 0,
     FROMCURRENCY type string,
     EXCHANGERATEDATE type TIMESTAMP,
     TOCURRENCY type string,
     TOAMOUNT type P length 16 decimals 0,
  end of TS_CONVERTCURRENCY03 .
  types:
TT_CONVERTCURRENCY type standard table of TS_CONVERTCURRENCY03 .
  types:
  begin of TS_CURRENCYCONV,
     FROMAMOUNT type P length 16 decimals 0,
     FROMCURRENCY type string,
     TOAMOUNT type P length 16 decimals 0,
     TOCURRENCY type string,
  end of TS_CURRENCYCONV .
  types:
TT_CURRENCYCONV type standard table of TS_CURRENCYCONV .
  types:
  begin of TS_DETERMINEPERIOD04,
     MONAT type C length 2,
  end of TS_DETERMINEPERIOD04 .
  types:
TT_DETERMINEPERIOD type standard table of TS_DETERMINEPERIOD04 .
  types:
  begin of TS_GLOBALPARAMETER05,
     CONSOLIDATIONUNIT type C length 18,
     FISCALYEAR type C length 4,
  ...
  end of TS_GLOBALPARAMETER05 .
  types:
TT_GLOBALPARAMETER type standard table of TS_GLOBALPARAMETER05 .
  types:
     TS_MESSAGES type BAPIRET2 .
  types:
TT_MESSAGES type standard table of TS_MESSAGES .
  types:
     TS_PTAATTACH type /EY1/RECPTA_ATCH .
  types:
TT_PTAATTACH type standard table of TS_PTAATTACH .
  types:
  ...
  types:
    begin of TS_XEY1XC_INTENTIONS_VALUESPAR.
      include type /EY1/C_INTENTIONS_VALUES.
  types:
      P_BUNIT type FC_BUNIT,
      P_GJAHR type GJAHR,
    end of TS_XEY1XC_INTENTIONS_VALUESPAR .
  types:
   TT_XEY1XC_INTENTIONS_VALUESPAR type standard table of TS_XEY1XC_INTENTIONS_VALUESPAR .
  types:
    begin of TS_XEY1XC_INTENTIONS_VALUESTYP.
      include type /EY1/C_INTENTIONS_VALUES.
  types:
      P_BUNIT type FC_BUNIT,
      P_GJAHR type GJAHR,
    end of TS_XEY1XC_INTENTIONS_VALUESTYP .
  types:
   TT_XEY1XC_INTENTIONS_VALUESTYP type standard table of TS_XEY1XC_INTENTIONS_VALUESTYP .
  types:
  ...
  types:
    begin of TS_XEY1XSAV_C_RECONCILIATIONPA.
      include type /EY1/SAV_C_RECONCILIATION.
  types:
      generated_id type string,
      P_RYEAR type GJAHR,
      P_FROMYB type POPER,
    ...
    end of TS_XEY1XSAV_C_RECONCILIATIONPA .
  types:
   TT_XEY1XSAV_C_RECONCILIATIONPA type standard table of TS_XEY1XSAV_C_RECONCILIATIONPA .
  types:
    begin of TS_XEY1XSAV_C_RECONCILIATIONRE.
      include type /EY1/SAV_C_RECONCILIATION.
  types:
      generated_id type string,
      P_RYEAR type GJAHR,
      ...
      P_TAXINTENTION type ZZ1_TAXINTENTION,
      P_INTENTION type ZZ1_TAXINTENTION,
    end of TS_XEY1XSAV_C_RECONCILIATIONRE .
  types:
   TT_XEY1XSAV_C_RECONCILIATIONRE type standard table of TS_XEY1XSAV_C_RECONCILIATIONRE .
  types:
  ...
  types:
   TS_C_CNSLDTNFISCALYEARVHTYPE type C_CNSLDTNFISCALYEARVH .
  types:
   TT_C_CNSLDTNFISCALYEARVHTYPE type standard table of TS_C_CNSLDTNFISCALYEARVHTYPE .
  types:
  ...
  constants GC_XEY1XSAV_C_RECONCILIATIONRE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'xEY1xSAV_C_ReconciliationResult' ##NO_TEXT.
  constants GC_XEY1XSAV_C_RECONCILIATIONPA type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'xEY1xSAV_C_ReconciliationParameters' ##NO_TEXT.
  ...
  constants GC_XEY1XC_INTENTIONS_VALUESTYP type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'xEY1xC_INTENTIONS_VALUESType' ##NO_TEXT.
  constants GC_XEY1XC_INTENTIONS_VALUESPAR type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'xEY1xC_INTENTIONS_VALUESParameters' ##NO_TEXT.
  ...
  constants GC_PTAATTACH type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PtaAttach' ##NO_TEXT.
  constants GC_POSTINGDATE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PostingDate' ##NO_TEXT.
  ...
  constants GC_DETERMINEPERIOD type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'DeterminePeriod' ##NO_TEXT.
  constants GC_DATAMONITORPARAMETERS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'DataMonitorParameters' ##NO_TEXT.
  ...
  constants GC_C_CNSLDTNFISCALYEARVHTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'C_CnsldtnFiscalYearVHType' ##NO_TEXT.
  ...
  constants GC_CURRENCYCONV type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'CurrencyConv' ##NO_TEXT.
  constants GC_CONVERTCURRENCY type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ConvertCurrency' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value '/EY1/CL_SAV_RECON_GAAP_MPC====CP' ##NO_TEXT.

  methods DEFINE_DATAMONITORPARAMETERS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_LEDGER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_POSTINGDATE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_CONVERTCURRENCY
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_CURRENCYCONV
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DETERMINEPERIOD
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS /EY1/CL_SAV_RECON_GAAP_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'EY1.SAV_RECON_GAAP_STAT_TAX_SRV' ).

define_datamonitorparameters( ).
define_ledger( ).
define_postingdate( ).
define_convertcurrency( ).
define_currencyconv( ).
define_determineperiod( ).
...
***********************************************************************************************************************************
*   ACTION - DataMonitorParameters
***********************************************************************************************************************************

lo_action = model->create_action( 'DataMonitorParameters' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'DataMonitorParameters' ). "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Action'    iv_abap_fieldname = 'ACTION' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
...
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'GroupCurrency'    iv_abap_fieldname = 'GROUPCURRENCY' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Ledger'    iv_abap_fieldname = 'LEDGER' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'LocalCurrency'    iv_abap_fieldname = 'LOCALCURRENCY' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'PeriodFrom'    iv_abap_fieldname = 'PERIODFROM' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'PeriodTo'    iv_abap_fieldname = 'PERIODTO' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_action->bind_input_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_DATAMONITORPARAMETERS' ). "#EC NOTEXT
***********************************************************************************************************************************
*   ACTION - PostingDate
***********************************************************************************************************************************

lo_action = model->create_action( 'PostingDate' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'PostingDate' ). "#EC NOTEXT
*Set HTTP method GET or POST
lo_action->set_http_method( 'GET' ). "#EC NOTEXT
* Set return type multiplicity
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Poper'    iv_abap_fieldname = 'POPER' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter->set_maxlength( iv_max_length = 3 ). "#EC NOTEXT
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'FiscalYear'    iv_abap_fieldname = 'FISCALYEAR' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_action->bind_input_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_POSTINGDATE' ). "#EC NOTEXT
***********************************************************************************************************************************
*   ACTION - ConvertCurrency
***********************************************************************************************************************************

lo_action = model->create_action( 'ConvertCurrency' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'ConvertCurrency' ). "#EC NOTEXT
*Set HTTP method GET or POST
lo_action->set_http_method( 'GET' ). "#EC NOTEXT
* Set return type multiplicity
lo_action->set_return_multiplicity( '1' ). "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Amount'    iv_abap_fieldname = 'AMOUNT' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_decimal( ).
lo_parameter->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_parameter->set_maxlength( iv_max_length = 3 ). "#EC NOTEXT
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'ExchangeRateDate'    iv_abap_fieldname = 'EXCHANGERATEDATE' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_datetime( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'FromCurrency'    iv_abap_fieldname = 'FROMCURRENCY' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter->set_maxlength( iv_max_length = 5 ). "#EC NOTEXT
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'ToCurrency'    iv_abap_fieldname = 'TOCURRENCY' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter->set_maxlength( iv_max_length = 5 ). "#EC NOTEXT
lo_action->bind_input_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_CONVERTCURRENCY' ). "#EC NOTEXT
***********************************************************************************************************************************
*   ACTION - DeterminePeriod
***********************************************************************************************************************************

lo_action = model->create_action( 'DeterminePeriod' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'DeterminePeriod' ). "#EC NOTEXT
*Set HTTP method GET or POST
lo_action->set_http_method( 'GET' ). "#EC NOTEXT
* Set return type multiplicity
lo_action->set_return_multiplicity( '1' ). "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'ConsolidationLedger'    iv_abap_fieldname = 'CHAR4' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'ConsolidationUnit'    iv_abap_fieldname = 'RBUNIT' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Date'    iv_abap_fieldname = 'DATE' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_datetime( ).
lo_action->bind_input_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_DETERMINEPERIOD' ). "#EC NOTEXT
***********************************************************************************************************************************
...
lo_action->bind_input_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_GLOBALPARAMETER' ). "#EC NOTEXT
  endmethod.


  method DEFINE_CONVERTCURRENCY.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - ConvertCurrency
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ConvertCurrency' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'FromAmount' iv_abap_fieldname = 'FROMAMOUNT' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FromCurrency' iv_abap_fieldname = 'FROMCURRENCY' ). "#EC NOTEXT
lo_property->set_is_key( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ExchangeRateDate' iv_abap_fieldname = 'EXCHANGERATEDATE' ). "#EC NOTEXT
lo_property->set_is_key( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ToCurrency' iv_abap_fieldname = 'TOCURRENCY' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ToAmount' iv_abap_fieldname = 'TOAMOUNT' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_CONVERTCURRENCY03' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ConvertCurrencySet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'CurrencyConv' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_CURRENCYCONV' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'CurrencyConvSet' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_DATAMONITORPARAMETERS.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - DataMonitorParameters
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'DataMonitorParameters' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_DATAMONITORPARAMETERS01' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'DataMonitorParametersSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - DeterminePeriod
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'DeterminePeriod' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'Period' iv_abap_fieldname = 'MONAT' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_DETERMINEPERIOD04' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'DeterminePeriodSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_GLOBALPARAMETER05' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_LEDGER' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PostingDate' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/EY1/CL_SAV_RECON_GAAP_MPC=>TS_POSTINGDATE02' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PostingDateSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PtaAttach' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Rbunit' iv_abap_fieldname = 'RBUNIT' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 18 ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Docnr' iv_abap_fieldname = 'DOCNR' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'ALPHA' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = '/EY1/RECPTA_ATCH'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PtaAttachSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20211110054115'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20211110064117'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20211110064117'.
    DATA(lv_sadl_xml) =
      ...
      lv_sadl_xml = |{ lv_sadl_xml }| &
               ...
               | <sadl:dataSource type="CDS" name="/EY1/C_INTENTIONS_VALUES" binding="/EY1/C_INTENTIONS_VALUES" />|  &
               ...
               | <sadl:dataSource type="CDS" name="/EY1/SAV_C_RECONCILIATION" binding="/EY1/SAV_C_RECONCILIATION" />|  &
               ...
               | <sadl:dataSource type="CDS" name="C_CNSLDTNFISCALYEARVH" binding="C_CNSLDTNFISCALYEARVH" />|  &
      ...
      lv_sadl_xml = |{ lv_sadl_xml }| &
               ...
               | </sadl:query>|  &
               |</sadl:structure>|  &
               |<sadl:structure name="xEY1xC_INTENTIONS_VALUESSet" dataSource="/EY1/C_INTENTIONS_VALUES" maxEditMode="RO" exposure="TRUE" >|  &
               | <sadl:query name="SADL_QUERY">|  &
               | </sadl:query>|  &
               |</sadl:structure>|  &
      ...
      lv_sadl_xml = |{ lv_sadl_xml }| &
               ...
               | </sadl:query>|  &
               |</sadl:structure>|  &
               |<sadl:structure name="xEY1xSAV_C_ReconciliationResults" dataSource="/EY1/SAV_C_RECONCILIATION" maxEditMode="RO" exposure="TRUE" >|  &
               | <sadl:query name="SADL_QUERY">|  &
               | </sadl:query>|  &
               | <sadl:association name="TO_ACCCODE_TEXT" binding="_ACCCODE_TEXT" target="xEY1xSAV_I_Acc_Class_Text" cardinality="zeroToOne" />|  &
      ...
      lv_sadl_xml = |{ lv_sadl_xml }| &
               ...
               | </sadl:query>|  &
               |</sadl:structure>|  &
               |<sadl:structure name="C_CnsldtnFiscalYearVH" dataSource="C_CNSLDTNFISCALYEARVH" maxEditMode="RO" exposure="TRUE" >|  &
               | <sadl:query name="SADL_QUERY">|  &
               | </sadl:query>|  &
               |</sadl:structure>|  &
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( '/EY1/SAV_RECON_GAAP_STAT_TAX' )
...
ls_text_element-parent_artifact_name   = 'DataMonitorParameters'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'MessageText'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DataMonitorParameters'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'LogNumber'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DataMonitorParameters'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PtaAttach'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
