@AbapCatalog.sqlViewName: '/EY1/ISTTOPMTLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'GL Account - S2T Other Permanent'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_Rec_S2T_OthrPmnt_LC
  with parameters
    p_ryear        : gjahr,
    p_toperiod     : poper,
