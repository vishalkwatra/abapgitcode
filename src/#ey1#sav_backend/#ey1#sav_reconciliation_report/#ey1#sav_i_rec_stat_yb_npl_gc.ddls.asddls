@AbapCatalog.sqlViewName: '/EY1/STATYBNPL'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I view for STAT YB Calculation - Non P&L'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_Rec_STAT_YB_NPL_GC
  with parameters
    p_ryear        : gjahr,
    p_fromyb       : poper,
    p_toyb         : poper,
