@AbapCatalog.sqlViewName: '/EY1/ERS2TOBEQLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER S2T OB EQ'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_ER_S2T_OB_EQ_LC
  with parameters
    p_ryear         : gjahr,
...

{
  ...
  key  racct    as GLAccount,
       ...
       sum(hsl) as S2TAdjustmentAmount,
