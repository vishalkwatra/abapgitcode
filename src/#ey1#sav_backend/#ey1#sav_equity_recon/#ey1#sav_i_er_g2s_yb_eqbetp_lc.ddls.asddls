@AbapCatalog.sqlViewName: '/EY1/ERGSYBEBELC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER G2S YB Eq BS, Eq, TE, PBT values for LC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_G2S_YB_EqBETP_LC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
  ...
  as select from /EY1/SAV_I_GlAcc_BSEQTERE_MD(p_ryear:$parameters.p_ryear)              as GLAcc
    ...
    inner join   /EY1/SAV_I_ER_G2S_YB_Eq_LC(p_toperiod:$parameters.p_toperiod,
