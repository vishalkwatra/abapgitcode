@AbapCatalog.sqlViewName: '/EY1/ERGAAPYBGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Interface View to fetch ER GAAP YB balance for GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_GAAPEQ_YB_GC
  with parameters
    p_ryear         : gjahr,
    p_fromperiod    : poper,
    p_toperiod      : poper,
  ...
  as select from    /EY1/SAV_I_GlAcc_EQ_MD( p_ryear: $parameters.p_ryear)                        as EQMD
    ...
    left outer join /EY1/SAV_I_ER_GAAPEQ_YB_PL_GC( p_ryear: $parameters.p_ryear,
