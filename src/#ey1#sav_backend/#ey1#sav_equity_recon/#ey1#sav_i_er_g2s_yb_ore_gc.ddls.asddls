@AbapCatalog.sqlViewName: '/EY1/ERGSYBOREGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER G2S YB Othr RE Values for GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_G2S_YB_ORE_GC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
  ...
  as select from    /EY1/SAV_I_GlAcc_BSEQTERE_MD(p_ryear:$parameters.p_ryear)                  as GLAcc
    ...
    left outer join /EY1/SAV_I_ER_G2S_YB_ORESum_GC(p_toperiod:$parameters.p_toperiod,
