@AbapCatalog.sqlViewName: '/EY1/ERGSOPPERGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER G2S YB Othr PL Pm Eq RE Values for GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_G2S_YB_OPPERE_GC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
