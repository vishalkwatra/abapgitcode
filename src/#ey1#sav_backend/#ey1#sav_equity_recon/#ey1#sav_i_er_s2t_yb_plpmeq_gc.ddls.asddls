@AbapCatalog.sqlViewName: '/EY1/ERS2TYPPEGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER S2T YB PL PM EQ  Sum Values for GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_S2T_YB_PLPmEq_GC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
