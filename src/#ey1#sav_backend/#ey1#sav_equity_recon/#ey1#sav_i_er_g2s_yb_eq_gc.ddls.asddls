@AbapCatalog.sqlViewName: '/EY1/ERGSYBEGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER G2S YB EqSum Values for GC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_ER_G2S_YB_Eq_GC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
