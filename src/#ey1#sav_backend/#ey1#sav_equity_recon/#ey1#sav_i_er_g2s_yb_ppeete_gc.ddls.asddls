@AbapCatalog.sqlViewName: '/EY1/ERGSPPEETGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER G2S YB PL Pmt Eq EQTE Sum Values for GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_G2S_YB_PPEETE_GC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
