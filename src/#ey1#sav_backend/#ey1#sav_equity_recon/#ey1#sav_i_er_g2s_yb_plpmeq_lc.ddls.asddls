@AbapCatalog.sqlViewName: '/EY1/ERG2SYPPELC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER G2S YB PL PM EQ  Sum Values for LC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_G2S_YB_PLPmEq_LC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
