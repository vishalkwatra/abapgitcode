@AbapCatalog.sqlViewName: '/EY1/ERSTOPPERGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER S2T YB Othr PL Pm Eq RE Values for GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_S2T_YB_OPPERE_GC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
