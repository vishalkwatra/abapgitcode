@AbapCatalog.sqlViewName: '/EY1/ERG2SOBRCLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View ER G2S YB Reconciliation Check of values'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_G2S_YB_RChk_LC
  with parameters
    p_ryear        : gjahr,
    p_toyb         : poper,
    p_fromyb       : poper,
  ...
  as select from    /EY1/SAV_I_GlAcc_PL_MD(p_ryear: $parameters.p_ryear) as GLAccnt
    ...
    left outer join /EY1/SAV_I_Rec_STAT_OB_YB_LC( p_ryear:$parameters.p_ryear ,
                    ...
                    )                                                    as StatCB on  StatCB.GLAccount         = GLAccnt.GLAccount
