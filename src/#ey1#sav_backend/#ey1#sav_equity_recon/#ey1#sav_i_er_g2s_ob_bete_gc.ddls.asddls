@AbapCatalog.sqlViewName: '/EY1/ERGSOBBETGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER G2S OB EQ TE and BS Sum Values for GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_G2S_OB_BETE_GC
  with parameters
    p_ryear        : gjahr,
