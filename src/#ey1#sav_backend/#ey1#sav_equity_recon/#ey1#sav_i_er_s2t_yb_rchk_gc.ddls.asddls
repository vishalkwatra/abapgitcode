@AbapCatalog.sqlViewName: '/EY1/ERS2TYBRCGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View ER S2T YB Reconciliation Check of values GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ER_S2T_YB_RChk_GC
  with parameters
    p_ryear         : gjahr,
    p_fromyb        : poper,
    p_toyb          : poper,
  ...
  as select from    /EY1/SAV_I_GlAcc_PL_MD(p_ryear: $parameters.p_ryear) as GLAccnt
    ...
    left outer join /EY1/SAV_I_Rec_TAX_OB_YB_GC( p_ryear:$parameters.p_ryear ,
                    ...
                    p_taxintention: $parameters.p_taxintention)        as TAXCB on  TAXCB.GLAccount         = GLAccnt.GLAccount
...

{
  ...
  key GLAccnt.FiscalYear,
      ...
      TaxClosingBalance as YBClosingBalance
