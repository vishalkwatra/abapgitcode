...
define view /EY1/SAV_I_ER_S2T_OB_RChk_LC
  ...
  as select from    /EY1/SAV_I_GlAcc_EQ_MD(p_ryear: $parameters.p_ryear) as GLAccnt
    ...
    left outer join /EY1/SAV_I_Rec_TAX_OB_LC( p_ryear:$parameters.p_ryear ,
                    p_taxintention:$parameters.p_taxintention )        as TAXOB on  TAXOB.GLAccount         = GLAccnt.GLAccount
