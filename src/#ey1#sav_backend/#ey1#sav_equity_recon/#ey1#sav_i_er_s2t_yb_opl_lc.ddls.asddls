@AbapCatalog.sqlViewName: '/EY1/ERS2TYBOPLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View to fetch ER S2T YB OPL Sum  Values for LC'
@VDM.viewType: #BASIC

define view /EY1/SAV_I_ER_S2T_YB_OPL_LC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  as select from acdocu
    ...
    inner join   /EY1/I_TRANS_TYPE                as TransType   on  TransType.rldnrassgnttype = 'OP&L'
