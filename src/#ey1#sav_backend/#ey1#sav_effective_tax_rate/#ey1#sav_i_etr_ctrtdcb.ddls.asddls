@AbapCatalog.sqlViewName: '/EY1/ETRCTCBPL'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View-ETR-Change in Tax Rate Effect Temp Diff CB'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_CTRTDCB
  with parameters
    p_fromperiod    : poper,
    p_toperiod      : poper,
    p_ryear         : gjahr,
    ...
    p_rbunit        : fc_bunit
  as select from /EY1/SAV_I_ETR_RS_CTRTDCB
