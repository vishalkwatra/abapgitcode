@AbapCatalog.sqlViewName: '/EY1/ETRRPYADTNR'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View ETR RGaap PYA DTRF PL NR'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_RG_PYA_DTRPL_NR
  with parameters
    p_fromperiod   : poper,
    p_toperiod     : poper,
    p_ryear        : gjahr,
    ...
    p_rbunit       : fc_bunit
  as select from    /EY1/SAV_I_ETR_RG_PYA_DTRPL
