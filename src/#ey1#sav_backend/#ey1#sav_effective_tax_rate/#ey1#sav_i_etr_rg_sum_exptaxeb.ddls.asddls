@AbapCatalog.sqlViewName: '/EY1/ETRSUMETEB'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View- ETR- RGAAP- Summary- Expected Tax Expense Benefit'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_RG_SUM_ExpTaxEB
  with parameters
    p_ryear         : gjahr,
    p_fromperiod    : poper,
    p_toperiod      : poper,
    ...
    p_rbunit        : fc_bunit
  as select from    /EY1/SAV_I_ETR_RG_SUM_PBT_LCGC
