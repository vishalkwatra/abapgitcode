@AbapCatalog.sqlViewName: '/EY1/ETRRGDDYBGC'
...
define view /EY1/SAV_I_ETR_RG_DDCTRTDYB_GC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  // Left outer join to map the Transaction Data
    left outer join /EY1/SAV_I_TRF_RGAAP_YB_PL_GC( p_toperiod:$parameters.p_toperiod ,
