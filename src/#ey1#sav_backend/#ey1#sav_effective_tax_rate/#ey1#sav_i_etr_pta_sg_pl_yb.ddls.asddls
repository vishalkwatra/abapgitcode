@AbapCatalog.sqlViewName: '/EY1/ETRPTASGYB'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View-ETR-PTA PL Movement SG'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_PTA_SG_PL_YB
  with parameters
    p_fromperiod    : poper,
    p_ryear         : gjahr,
    p_toperiod      : poper,
  ...
  as select from    /EY1/SAV_I_ETR_PTA_PL_YB_LCGC( p_ryear:$parameters.p_ryear ,
    ...
    left outer join /EY1/SAV_I_ETR_SG_SUM_ExpTaxEB( p_ryear:$parameters.p_ryear ,
