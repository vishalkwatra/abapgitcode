@AbapCatalog.sqlViewName: '/EY1/ETRSPYADTNR'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View ETR SGaap PYA DTRF PL NR'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_SG_PYA_DTRPL_NR
  with parameters
    p_fromperiod   : poper,
    p_toperiod     : poper,
    p_ryear        : gjahr,
    ...
    p_rbunit       : fc_bunit
  as select from    /EY1/SAV_I_ETR_SG_PYA_DTRPL
                                                                    ...
                                                                    and PBT.CurrType                     = GlAccount.CurrencyType
{
  ...
  key GlAccount.FiscalYear,
      ...
      ((cast( TaxAmount *  MultiFactor as abap.fltp(16,16)) / cast (PBT as abap.fltp(16,16))) *  cast (100 as abap.fltp(16,16))) end as Percentage,
