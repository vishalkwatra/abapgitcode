@AbapCatalog.sqlViewName: '/EY1/ETRSGCTCBLC'
...
define view /EY1/SAV_I_ETR_SG_CTRTDCBPL_LC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  // Left outer join to map the Transaction Data
    left outer join /EY1/SAV_I_TRF_SGAAP_CB_PL_LC( p_toperiod:$parameters.p_toperiod ,
