@AbapCatalog.sqlViewName: '/EY1/ETRSPYADTLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View ETR SGaap PYA DTRF PL LC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_SG_PYA_DTRPL_LC with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
  ...
  // Left outer join to map the Transaction Data
    left outer join /EY1/SAV_I_DTRF_SGAAP_PYA_PL(
