@AbapCatalog.sqlViewName: '/EY1/ETRPTAPLGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View-ETR-PTA PL Movement GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_PTA_PL_YB_GC
  with parameters
    p_ryear         : gjahr,
    p_toperiod      : poper,
    p_rbunit        : fc_bunit,
  ...
  as select from    /EY1/SAV_I_GlAcc_PL_MD
    ...
    left outer join /EY1/SAV_I_ETR_PTA_YB_GC( p_toperiod:$parameters.p_toperiod,
