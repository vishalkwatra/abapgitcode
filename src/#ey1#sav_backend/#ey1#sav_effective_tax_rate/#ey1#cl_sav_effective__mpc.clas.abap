...
TT_GLOBALPARAMETER type standard table of TS_GLOBALPARAMETER01 .
  ...
  types:
    begin of TS_XEY1XSAV_C_ETR_RS_PYADTRPLP.
      include type /EY1/SAV_C_ETR_RS_PYADTRPL.
  types:
      P_FROMPERIOD type POPER,
      P_TOPERIOD type POPER,
      P_RYEAR type GJAHR,
      ...
      P_TAXINTENTION type ZZ1_TAXINTENTION,
      P_RBUNIT type FC_BUNIT,
    end of TS_XEY1XSAV_C_ETR_RS_PYADTRPLP .
  types:
   TT_XEY1XSAV_C_ETR_RS_PYADTRPLP type standard table of TS_XEY1XSAV_C_ETR_RS_PYADTRPLP .
  types:
    begin of TS_XEY1XSAV_C_ETR_RS_PYADTRPLT.
      include type /EY1/SAV_C_ETR_RS_PYADTRPL.
  types:
      P_FROMPERIOD type POPER,
      P_TOPERIOD type POPER,
      ...
      P_TAXINTENTION type ZZ1_TAXINTENTION,
      P_RBUNIT type FC_BUNIT,
    end of TS_XEY1XSAV_C_ETR_RS_PYADTRPLT .
  types:
   TT_XEY1XSAV_C_ETR_RS_PYADTRPLT type standard table of TS_XEY1XSAV_C_ETR_RS_PYADTRPLT .
  types:
    begin of TS_XEY1XSAV_C_ETR_RS_PYATOTALP.
      include type /EY1/SAV_C_ETR_RS_PYATOTAL.
  types:
      P_FROMPERIOD type POPER,
      P_TOPERIOD type POPER,
      P_RYEAR type GJAHR,
      ...
      P_TAXINTENTION type ZZ1_TAXINTENTION,
      P_RBUNIT type FC_BUNIT,
    end of TS_XEY1XSAV_C_ETR_RS_PYATOTALP .
  types:
   TT_XEY1XSAV_C_ETR_RS_PYATOTALP type standard table of TS_XEY1XSAV_C_ETR_RS_PYATOTALP .
  types:
    begin of TS_XEY1XSAV_C_ETR_RS_PYATOTALT.
      include type /EY1/SAV_C_ETR_RS_PYATOTAL.
  types:
      P_FROMPERIOD type POPER,
      P_TOPERIOD type POPER,
      ...
      P_TAXINTENTION type ZZ1_TAXINTENTION,
      P_RBUNIT type FC_BUNIT,
    end of TS_XEY1XSAV_C_ETR_RS_PYATOTALT .
  types:
   TT_XEY1XSAV_C_ETR_RS_PYATOTALT type standard table of TS_XEY1XSAV_C_ETR_RS_PYATOTALT .
  types:
  ...
  constants GC_XEY1XSAV_C_ETR_RS_PYATOTALT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'xEY1xSAV_C_ETR_RS_PYATotalType' ##NO_TEXT.
  constants GC_XEY1XSAV_C_ETR_RS_PYATOTALP type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'xEY1xSAV_C_ETR_RS_PYATotalParameters' ##NO_TEXT.
  constants GC_XEY1XSAV_C_ETR_RS_PYADTRPLT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'xEY1xSAV_C_ETR_RS_PYADTRPLType' ##NO_TEXT.
  constants GC_XEY1XSAV_C_ETR_RS_PYADTRPLP type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'xEY1xSAV_C_ETR_RS_PYADTRPLParameters' ##NO_TEXT.
...
lo_action->bind_input_structure( iv_structure_name  = '/EY1/CL_SAV_EFFECTIVE__MPC=>TS_GLOBALPARAMETER' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20211117123710'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20211117133711'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20211117133711'.
    DATA(lv_sadl_xml) =
               ...
               | <sadl:dataSource type="CDS" name="/EY1/SAV_C_ETR_RS_PYADTRPL" binding="/EY1/SAV_C_ETR_RS_PYADTRPL" />|  &
               | <sadl:dataSource type="CDS" name="/EY1/SAV_C_ETR_RS_PYATOTAL" binding="/EY1/SAV_C_ETR_RS_PYATOTAL" />|  &
      ...
      lv_sadl_xml = |{ lv_sadl_xml }| &
               ...
               | </sadl:query>|  &
               |</sadl:structure>|  &
               |<sadl:structure name="xEY1xSAV_C_ETR_RS_PYADTRPLSet" dataSource="/EY1/SAV_C_ETR_RS_PYADTRPL" maxEditMode="RO" exposure="TRUE" >|  &
               | <sadl:query name="SADL_QUERY">|  &
               | </sadl:query>|  &
               |</sadl:structure>|  &
               |<sadl:structure name="xEY1xSAV_C_ETR_RS_PYATotalSet" dataSource="/EY1/SAV_C_ETR_RS_PYATOTAL" maxEditMode="RO" exposure="TRUE" >|  &
               | <sadl:query name="SADL_QUERY">|  &
               | </sadl:query>|  &
               |</sadl:structure>|  &
