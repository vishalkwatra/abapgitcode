@AbapCatalog.sqlViewName: '/EY1/ETRCCTCBPL'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'C-View-ETR-Change in Tax Rate Effect Temp Diff CB'
@Search.searchable: true
@VDM.viewType: #CONSUMPTION

define view /EY1/SAV_C_ETR_CTRTDCB
 with parameters
    p_fromperiod    : poper,
    p_toperiod      : poper,
    p_ryear         : gjahr,
    ...
    p_rbunit        : fc_bunit
  as select from /EY1/SAV_I_ETR_CTRTDCB ( p_fromperiod: $parameters.p_fromperiod, p_toperiod: $parameters.p_toperiod,
