@AbapCatalog.sqlViewName: '/EY1/CETRDDCTR'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'C-View- ETR- Summary- Diff Deferred & CTR- TempDiff'
@Search.searchable: true
@VDM.viewType: #CONSUMPTION

define view /EY1/SAV_C_ETR_SUM_DDCTRTD
  with parameters
    p_fromperiod    : poper,
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  as select from /EY1/SAV_I_ETR_SUM_DDCTRTD ( p_fromperiod: $parameters.p_fromperiod, p_toperiod: $parameters.p_toperiod,
