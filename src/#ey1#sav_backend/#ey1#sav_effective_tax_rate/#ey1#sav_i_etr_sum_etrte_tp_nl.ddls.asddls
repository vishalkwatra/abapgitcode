...
define view /EY1/SAV_I_ETR_SUM_ETRTE_TP_NL
  ...
  as select from    /EY1/SAV_I_ETR_RS_SUM_ExpTaxEB
                 ( p_ryear:$parameters.p_ryear ,
                                  ...
                                  p_rbunit: $parameters.p_rbunit) as ExpTaxExpBenefit
    ...
    left outer join /EY1/SAV_I_ETR_SUM_DDCTRTotal
                    ...
                    p_switch: $parameters.p_switch,
                    p_taxintention: $parameters.p_taxintention,
                    p_rbunit: $parameters.p_rbunit)               as DiffDefAndCTETotal       on  DiffDefAndCTETotal.ConsolidationChartofAccounts = ExpTaxExpBenefit.ConsolidationChartofAccounts
    ...
    left outer join /EY1/SAV_I_ETR_BDTPD_BDDTTotal( p_fromperiod: $parameters.p_fromperiod,
                    ...
                    p_switch: $parameters.p_switch,
                    p_taxintention: $parameters.p_taxintention,
                    p_rbunit: $parameters.p_rbunit)               as BasDiffNoDeffTaxCalTotal on  BasDiffNoDeffTaxCalTotal.ConsolidationChartofAccounts = ExpTaxExpBenefit.ConsolidationChartofAccounts
    ...
    left outer join /EY1/SAV_I_ETR_PTA_Total( p_fromperiod:$parameters.p_fromperiod ,
                    ...
                    p_switch: $parameters.p_switch,
                    p_taxintention:$parameters.p_taxintention)  as PTATotal                 on  PTATotal.ConsolidationChartofAccounts = ExpTaxExpBenefit.ConsolidationChartofAccounts
