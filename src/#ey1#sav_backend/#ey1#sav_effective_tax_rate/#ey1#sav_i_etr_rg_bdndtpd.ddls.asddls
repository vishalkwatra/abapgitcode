@AbapCatalog.sqlViewName: '/EY1/ETRRGBDNDT'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View-ETR-RGAAP-Diff for whch no Def tax is cal- PermDiff'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_RG_BDNDTPD
  with parameters
    p_fromperiod    : poper,
    p_toperiod      : poper,
    p_ryear         : gjahr,
    ...
    p_rbunit        : fc_bunit
  as select from    /EY1/SAV_I_ETR_RG_BDNDTPDYB
                                                           ...
                                                           and PBT.CurrType                     = GlAccount.CurrencyType
{
  ...
  key GlAccount.FiscalYear,
      ...
      PmntYearBalance                                                                                                                            as Amount,
      Rate,

      // Tax = (Amount * Rate) / 100
      PmntYearBalance * Rate * MultiFactor                                                                                                       as Tax,
      ...
      ((cast( PmntYearBalance * Rate * MultiFactor as abap.fltp(16,16)) / cast (PBT as abap.fltp(16,16))) *  cast (100 as abap.fltp(16,16))) end as Percentage,
