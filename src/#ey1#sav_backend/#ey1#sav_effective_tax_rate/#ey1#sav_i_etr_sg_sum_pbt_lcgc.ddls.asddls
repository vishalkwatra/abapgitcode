@AbapCatalog.sqlViewName: '/EY1/ETRSGPBT'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View- ETR- SGAAP- Summary Section- PBT LC GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_SG_SUM_PBT_LCGC
  with parameters
    p_ryear         : gjahr,
    p_fromperiod    : poper,
    p_toperiod      : poper,
                  ...
                  p_intention: $parameters.p_intention)
{
  ...
  key ConsolidationUnit,
      ...
      case when PBT is null then cast(0 as abap.curr(23,2)) else (PBT * (-1)) end as PBT,

      'Local'                                                                     as CurrType
}
union all select from /EY1/SAV_I_ETR_SG_SUM_PBT_GC
                      ( p_ryear:$parameters.p_ryear,
                      p_fromperiod:$parameters.p_fromperiod,
                      p_toperiod:$parameters.p_toperiod,
