@AbapCatalog.sqlViewName: '/EY1/ETRSGDDYBGC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View- ETR- SGAAP- Diff Deferred & CTR- TempDiff YB GC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_SG_DDCTRTDYB_GC
with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  // Left outer join to map the Transaction Data
    left outer join /EY1/SAV_I_TRF_SGAAP_YB_PL_GC( p_toperiod:$parameters.p_toperiod ,
