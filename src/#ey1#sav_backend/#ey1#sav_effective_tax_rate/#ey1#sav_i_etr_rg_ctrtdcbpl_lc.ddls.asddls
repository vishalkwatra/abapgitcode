@AbapCatalog.sqlViewName: '/EY1/ETRRGCTCBLC'
...
define view /EY1/SAV_I_ETR_RG_CTRTDCBPL_LC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  // Left outer join to map the Transaction Data
    left outer join /EY1/SAV_I_TRF_RGAAP_CB_PL_LC( p_toperiod:$parameters.p_toperiod ,
...

{
  ...
  key MasterData.FiscalYear,
      ...
      cast(GaapCBDTRate as /ey1/sav_rate)- cast(GaapOBDTRate as /ey1/sav_rate) as Rate,
      MultiFactor,
