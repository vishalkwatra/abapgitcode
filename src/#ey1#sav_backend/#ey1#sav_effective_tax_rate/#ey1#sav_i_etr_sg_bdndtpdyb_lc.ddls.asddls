@AbapCatalog.sqlViewName: '/EY1/ETRSGBDYBLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View-ETR-SGAAP-Diff fr whch no Def tax is cal PermDif YBLC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_SG_BDNDTPDYB_LC
  with parameters
    p_toperiod      : poper,
    p_ryear         : gjahr,
  ...
  // Left outer join to map the Transaction Data
    left outer join /EY1/SAV_I_TRF_SGAAP_YB_PMT_LC( p_toperiod:$parameters.p_toperiod ,
