@AbapCatalog.sqlViewName: '/EY1/ETRRPYADTLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'I-View ETR RGaap PYA DTRF PL LC'
@VDM.viewType: #COMPOSITE

define view /EY1/SAV_I_ETR_RG_PYA_DTRPL_LC
  with parameters
    p_toperiod     : poper,
    p_ryear        : gjahr,
  ...
  // Left outer join to map the Transaction Data
    left outer join /EY1/SAV_I_DTRF_RGAAP_PYA_PL(
